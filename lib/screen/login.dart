...
// import 'package:watterplannet/src/services/auth.dart';
// import 'package:watterplannet/src/utils/flushbar.dart';
          ...
          children: <Widget>[
            new Expanded(
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  border: InputBorder.none,
                  hintText: 'Residencial Prado Oriental, Pimienta #35',
                  hintStyle: TextStyle(color: Colors.blueGrey),
                ),
              ),
            ),
