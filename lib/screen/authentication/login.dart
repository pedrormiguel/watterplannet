...
class _LoginScreenState extends State<Login> with TickerProviderStateMixin {
  ...
  String correo = "orange@o.com";
  var boxDecorationForm = BoxDecoration(
      border: Border(
          bottom: BorderSide(
  ...
  BoxDecoration customBackgroundPicture = BoxDecoration(
      ...
      image: DecorationImage(
        ...
        image: AssetImage(
            'assets/backgroundLogin.jpg'), //TODO AGREGAR VARIABLE DE FONDO NO TEXTO
        fit: BoxFit.cover,
      ));
  ...
  Widget loginPage() {
    return Form(
      ...
      child: SingleChildScrollView(
          ...
          decoration:
              BoxDecoration(color: Colors.transparent, image: customImage),
          child: Column(
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintStyle: TextStyle(color: Colors.blueGrey, fontSize: SizeConfig.safeBlockHorizontal * 3,),
                                ),
                              ),
                            ),
                          ],
  ...
  Future<void> logIn() async {
    ...
    if (_loginKey.currentState.validate()) {
      ...
      if (output.runtimeType != String && output != null) {
        ...
        Navigator.pushReplacementNamed(context, userlogged.loggin(),
    ...
    if (p.value != null) {
      ...
      values.forEach((key, value) {
        user = Supplier.fromMap(
            ...
            imageUser: value["imageUser"] == null
  ...
  void signIn() async {
    ...
    if (this._signUpKey.currentState.validate()) {
      ...
      if (outputFromEmailAccount != null &&
          outputFromEmailAccount.runtimeType != String) {
        Consumer(
  ...
  Widget customTextField(var fieldC, String hintext, String header,
      bool isObscureText, int minimunLength,
